...
if [ ! -f "${openapphack_bash_profile}" -a ! -f "${openapphack_profile}" ]; then
	...
	if [ -f "${openapphack_bash_profile}" ]; then
		if [[ -z `grep 'oah-init.sh' "${openapphack_bash_profile}"` ]]; then
	...
	if [ -f "${openapphack_profile}" ]; then
		if [[ -z `grep 'oah-init.sh' "${openapphack_profile}"` ]]; then
...
if [ ! -f "${openapphack_bashrc}" ]; then
	...
	if [[ -z `grep 'oah-init.sh' "${openapphack_bashrc}"` ]]; then
...
if [ ! -f "${openapphack_zshrc}" ]; then
	...
	if [[ -z `grep 'oah-init.sh' "${openapphack_zshrc}"` ]]; then
